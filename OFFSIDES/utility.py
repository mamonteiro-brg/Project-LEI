...
def load_combo_se(fname='/home/mamonteiro/datasets/bio-decagon-combo/bio-decagon-combo.csv'):
    combo2stitch = {}
...
def load_ppi(fname='/home/mamonteiro/datasets/bio-decagon-ppi/bio-decagon-ppi.csv'):
    fin = open(fname)
    print ('Reading: %s' % fname)
    fin.readline()
    edges = []
...
# and dictionary from side effects to their names.
def load_mono_se(fname='/home/mamonteiro/datasets/bio-decagon-mono/bio-decagon-mono.csv'):
...
def load_targets(fname='/home/mamonteiro/datasets/bio-decagon-targets/bio-decagon-targets.csv'):
...
# and dictionary from side effects to their names.
def load_categories(fname='/home/mamonteiro/datasets/bio-decagon-effectcategories/bio-decagon-effectcategories.csv'):
    se2name = {}
    se2class = {}
    fin = open(fname)
    #print 'Reading: %s' % fname
