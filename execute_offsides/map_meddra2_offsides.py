...
def preprocess_data2(filepath, output_file):
    ...
    cuis.to_csv('output_file.csv', index=False)
...
preprocess_data2(filepath="/home/mamonteiro/source-code/Project-LEI/execute_offsides/3003377s-offsides.tsv", output_file="/home/mamonteiro/source-code/Project-LEI/execute_offsides//offsides_socs.csv")
#preprocess_data2(filepath="/home/pg37158/my-code/3003377s-twosides.tsv", output_file="/home/pg37158/my-code/twosides_socs.csv")
